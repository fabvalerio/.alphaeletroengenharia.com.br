...
<h2 class="head">Logo &bull; Footer</h2>
  ...
  <tr>
    ...
    <fieldset>
      ...
      <div>
		...
		@mkdir( $__pastaFotos.'footer', 0777 );
		@chmod( $__pastaFotos.'footer', 0777 );
			...
			if( !empty($_FILES['file']['name']) ):
			   ...
			   if(move_uploaded_file($_FILES['file']['tmp_name'], $__pastaFotos . "/footer/" . $NomeArquivoBanner ))
			   {					
