...
<h2 class="mb-3">Deseja realmente excluir, <small><? echo $_GET['titulo']; ?></small> ?</h2>

<h3 class="bg-danger text-white p-3 mb-3"><i class="fas fa-skull-crossbones"></i> Cuidado, essa op&ccedil;&atilde;o &eacute; sem volta!!!</h3>

<form action="" id="form">
	<div class="card">
		<div class="card-body">
			<input type="hidden" name="id" value="<? echo $link[3]; ?>">
			<input type="hidden" name="redirecionar" value="visualizar">
			<input type="hidden" name="tabela" value="seo">
			<input type="hidden" name="coluna" value="seo_id">
