...
function is_img(file, title) {
	...
	img.onload = function() {
		...
		jQuery("#capa-imagem").html('<img src="'+file+'" alt="'+title+'" class="card-img-top">');
	}
...
if( conteudo != "" ){
	...
	obj.forEach(function(ver, index){
		...
		is_img(ver.url+'painel/images/fotos-paginas/'+ver.pag_id+'/m/'+ver.pag_capa, ver.pag_titulo);
