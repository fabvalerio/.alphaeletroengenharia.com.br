...
if( $link[3] == 'envio' ){
    ...
    echo '<meta http-equiv="refresh" content="2;URL='.$url.'!/'.$link[1].'/'.$link[2].'&file='.$_file.'" />';
}
...
<form enctype="multipart/form-data" action="<?=$url."!/".$link[1]."/".$link[2]?>/envio&file=<? echo $_file ?>" method="post">
