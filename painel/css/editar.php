...
<hr>
<h2 class="display-4 mb-3">CSS/LESS &bull; Editar</h2>

<form enctype="multipart/form-data" action="<? echo $url.'!/'.$link[1].'/'.$link[2].'/'.$link[3]?>/envio" method="post">
  <table class="table table-bordered">
    <tr>
      <th width="150" valign="middle">T&iacute;tulo</th>
      <td valign="middle" colspan="8">
        <input class="form-control" name="css_titulo" type="text" autofocus id="css_titulo" autocomplete="off" value="<? echo $edi->css_titulo?>" size="60" maxlength="200" /> 
      </td>
    </tr>
    ...
    <tr>
      <td colspan="8">
        <textarea id="code" name="css_codigo" class="cm-s-icecoder"><? echo $edi->css_codigo?></textarea>
      </td>
    </tr>
    ...
    <tr>
      <td  colspan="8">
        ...
        <input type="hidden" name="css_id" id="css_id" value="<? echo $link[3]?>">
      </td>
    </tr>
  </table>
</form>
