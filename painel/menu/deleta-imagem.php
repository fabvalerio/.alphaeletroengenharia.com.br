...
<h2 class="display-4 mb-3"><span>Excluir Imagem<span></span></span></h2>


<div class="col-sm-4 col-md-4 text-xs-center">
<div style="margin:15px;" class="thumbnail">
<img src="<?=$url?><?=$link[4]?>/<?=$link[5]?>/<?=$link[6]?>/<?=$link[7]?>/<?=$link[8]?>" width="" height="200" alt=""/> 
</div>
